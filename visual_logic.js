...
const createPzLib = ({ v3d=null, appInstance=null }) => {
    ...
    return {
        ...
        unbindListener, getEventOffsetCoords, isChangedTouchOrNotTouchEventAtAll, getEventFirstTouchId,
        createDragOverInfo,
    };
};
...
createCSSRule('.warning-could-not-enter-AR', "position: absolute; width: 181px; height: 50px; left: 50%; margin-left: -90.5px; display: none; z-index: 1;", false, '');
...
setHTMLElemAttribute('href', 'https://suzy.com', 'info_button', false);
...
operateAnimation('PLAY', 'suzy_Armature', 0, 180, 'LoopRepeat', 1,
        function() {}, false);


volume(loadMedia_WebAudio('sounds/hello.mp3'), 2);
registerOnClick('suzy_mesh', false, false, [0,1,2], function() {

  operateAnimation('STOP', 'suzy_Armature', null, null, 'AUTO', 1,
          function() {}, false);

      playSound(loadMedia_WebAudio('sounds/hello.mp3'), false);

  operateAnimation('PLAY', 'suzy_Armature', 181, 275, 'LoopOnce', 1,
          function() {
...
checkARMode(function() {
  eventHTMLElem('pointerup', 'enter_AR_button', false, function(event) {
    enterARMode('ORIGIN', true, function() {
      changeVis(['GROUP', 'Suzy_group'], false);
      ...
      changeVis(['GROUP', 'Suzy_group'], true);
      changeVis('prompt_move_around', false);
      setObjTransform('suzy_Armature', false, 'position', createVector(0, 0, 0), false);
      ...
      setObjTransform('suzy_Armature', false, 'scale', [1, 1, 1], false);
...
registerOnClick('indicator_invis_plane', false, false, [0,1,2], function() {
  changeVis(['GROUP', 'Suzy_group'], true);
  setObjTransform('suzy_Armature', false, 'position', [arHitPoint('x'), arHitPoint('y'), arHitPoint('z')], false);
  setObjDirection('suzy_Armature', getObjTransform('Camera', false, 'position', 'xyz'), true, true);
...
registerOnDrag('drag_move', false, [0,1,2], function() {}, function() {
  dragMoveAdv('suzy_Armature', 'XY', 'WORLD', 'RxbpdjC3HRNQ[+oLVAh_', '@biuVVI~Y7S3J*}bA*MR');
}, function() {}, '@biuVVI~Y7S3J*}bA*MR');

registerOnDrag('drag_rotate', false, [0,1,2], function() {}, function() {
  dragRotateAdv('suzy_Armature', 'X', 'WORLD', 'lmm_7Gu,cy[`-%hw9q_*', 'L{Gpth6ArhGdUF+mm)Yc');
}, function() {}, 'L{Gpth6ArhGdUF+mm)Yc');

registerOnDrag('drag_scale', false, [0,1,2], function() {}, function() {
  dragScale('suzy_Armature', 'X', 'v_8n$~qa~(qZ[[=G{2r#', 'r+ib5hihs+JMNWR!v%`f');
  dragScale('suzy_Armature', 'Z', '_az:%G$z{KgiNHWy28Mt', 'r+ib5hihs+JMNWR!v%`f');
  dragScale('suzy_Armature', 'Y', 'xJ.FK_Q^%VW(gniZa6kJ', 'r+ib5hihs+JMNWR!v%`f');
  updateTextObj('scale_percentage', String(Math.round(toFixedPoint(getObjTransform('suzy_Armature', false, 'scale', 'z'), 2) * 100)) + '%');
}, function() {}, 'r+ib5hihs+JMNWR!v%`f');
